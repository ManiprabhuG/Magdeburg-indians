      ...
      <div class="container">
          ...
          <div class="columns-wrapper">
            <div class="flex">
              ...
              <div class="colm">
              <div class="feature-image"><a href="event-slider-22.php"><img class="img-fluid-5" src="images/events/2022/Republic Day 2022/img2.jpg" alt="Image" /></a></div>
                
                  <h5>Republic Day</h5>
                     <a class="feature-btn-2" href="event-slider-22.php">SEE MORE<i class="fas fa-arrow-right"></i></a>
              </div>
            </div>  
          </div>
        </div>
