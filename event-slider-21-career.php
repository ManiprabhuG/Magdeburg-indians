...
<link href="https://fonts.googleapis.com/css2?family=Hind+Siliguri:wght@300;600&family=Lobster&family=Mukta&family=Poppins:wght@500&display=swap" rel="stylesheet">
        ...
        <div class="row">
          ...
          <div class="col-md-5 offset-md-2">
            <div class="section-title text-center">
              ...
              <h2>Career Webinar Series 2021</h2>
            </div>
          </div>
        </div>
  ...
  <div class="col-6 col-md-4 col-lg-3 p-0">
    <img class="w-100" src="images/events/2021/Career Webinar Series 2021/Career Webinar Series.jpg" alt="First slide" data-target="#carouselExample" data-slide-to="0">
  </div>
      ...
      <div class="modal-body p-0">
        <div id="carouselExample" class="carousel slide carousel-fade" data-ride="false">
            <div class="carousel-item active">
              <img class="d-block w-100" src="images/events/2021/Career Webinar Series 2021/Career Webinar Series.jpg" alt="First slide" style="height:95vh;"; >
            </div>
          </div>
